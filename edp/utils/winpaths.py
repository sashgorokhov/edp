...
class GUID(ctypes.Structure):
    ...
    def __init__(self, uid: UUID):
        ...
        self.Data1, self.Data2, self.Data3, self.Data4[0], self.Data4[1], rest = uid.fields
        for i in range(2, 8):
...
def get_known_folder_path(known_folder_uid: UUID, user_handle: wintypes.HANDLE = UserHandle.current) -> pathlib.Path:
    ...
    if _SHGetKnownFolderPath(ctypes.byref(guid), 0, user_handle, ctypes.byref(p_path)) != 0:
