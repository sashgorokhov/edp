...
Generated by 🤖
    ...
    api.upload_asset(upload_url, DIST_ZIP, 'application/zip', f'EDP-{version}-win64.zip', label='DEFAULT_ZIP')
    api.upload_asset(upload_url, WIX_MSI, 'application/x-msi', f'EDP-{version}-win64.msi', label='DEFAULT_INSTALLER')
    print(data['html_url'])
